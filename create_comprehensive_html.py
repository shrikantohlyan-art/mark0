...
# Load the updated graph data with database relationships
...
<head>
<meta charset="UTF-8">
<title>Connected Graph with Database Relationships - Jarvis Knowledge Graph</title>
...
const nodes = new vis.DataSet(graphData.nodes.map(n => ({
  ...
  size: 8 + Math.min((graphData.links.filter(l => l._src === n.id || l._tgt === n.id).length * 0.3), 12),
...
# Write the HTML file
with open('graphify-out/graph_connected_with_db.html', 'w') as f:
    f.write(html_template)

print("Created comprehensive HTML visualization: graphify-out/graph_connected_with_db.html")